...
func lo_que_se_percibe_desde_el_cuarto_objetos():
	...
	var contextos = [
		{
			...
			"posicion": "Posición del jugador: Parado dentro del cuarto de objetos, junto a una pared al este colindante con otro cuarto. Observa sus alrededores, pero no se mueve de su posición.\n"
		},
		{
			"llave": "en_dragon",
			"contexto": "Contexto omnisciente: En el cuarto del dragón se encuentra: %s\n",
			"posicion": "Posición del jugador: Parado en el cuarto de objetos, junto a la pared al este colindante con el cuarto del dragón. Observa sus alrededores, pero no se mueve de su posición.\n"
		},
		{
			"llave": "en_valle",
			"contexto": "Contexto omnisciente: En el exterior se encuentra: %s\n",
			"posicion": "Posición del jugador: Parado dentro de un cuarto, junto a una pared al este colindante con otro cuarto. Observa sus alrededores, pero no se mueve de su posición.\n"
		}
	]
	...
	for contexto in contextos:
		for elemento in llaves[contexto["llave"]]:
			...
			descripcion_elemento += contexto["posicion"]
